...
export default function App() {
  ...
  const topThreeToday = useMemo(() => {
    ...
    return [...barracas].sort((a, b) => {
      const votesA = a.dailyVotes?.[dayKey] || 0;
      const votesB = b.dailyVotes?.[dayKey] || 0;
      if (votesB !== votesA) return votesB - votesA;
      return b.voteCount - a.voteCount;
    }).slice(0, 3);
  }, [barracas, getAcademicDayKey]);
  ...
  return (
    <div className="min-h-screen bg-brand-dark text-white font-sans overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8 p-6 pb-12">
        {/* Today's Leaders - Top Strip (Especially for Mobile) */}
        <div className="col-span-1 md:col-span-12 mb-2">
          <div className="bg-blue-600/10 border border-blue-500/30 p-4 rounded-sm">
            <h3 className="text-[10px] font-black uppercase tracking-[0.2em] mb-4 text-blue-400 flex items-center gap-2">
